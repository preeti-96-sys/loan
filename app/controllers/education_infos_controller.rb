class EducationInfosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @education_info.save
        format.html { redirect_to @education_info, notice: "Education info was successfully created." }
  ...
  def update
    respond_to do |format|
      if @education_info.update(education_info_params)
        format.html { redirect_to @education_info, notice: "Education info was successfully updated." }
  ...
  private
    ...
    def education_info_params
      params.require(:education_info).permit(:Name, :Guardian_or_Parent_Name, :Phone, :Age_of_Student, :Course_Name, :Duration_Of_Course_in_years)
    end
end
