...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { Age: @detail.Age, City: @detail.City, Desired_Loan_Amount: @detail.Desired_Loan_Amount, Email: @detail.Email, Name: @detail.Name, Net_Monthly: @detail.Net_Monthly, Phone: @detail.Phone } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { Age: @detail.Age, City: @detail.City, Desired_Loan_Amount: @detail.Desired_Loan_Amount, Email: @detail.Email, Name: @detail.Name, Net_Monthly: @detail.Net_Monthly, Phone: @detail.Phone } }
